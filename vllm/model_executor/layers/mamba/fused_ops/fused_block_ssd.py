...
@triton.autotune(
    configs=[
        triton.Config({'BLOCK_SIZE_TT': 16}),
        triton.Config({'BLOCK_SIZE_TT': 32}),
        triton.Config({'BLOCK_SIZE_TT': 64}),
        triton.Config({'BLOCK_SIZE_TT': 128}),
        triton.Config({'BLOCK_SIZE_TT': 256}),
    ],
    key=[],
)
@triton.jit
